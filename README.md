...
- [Установка](#installation)
  - [Начало работы с Docker (рекомендуется)](#getting-started-with-docker-recommended)
  - [Установка без использования Docker](#non-docker-installation)
  - [Ошибки подключения Ollama](#ollama-connection-errors)
- [Использование в качестве поисковой системы](#using-as-a-search-engine)
- [Использование API Perplexica](#using-perplexicas-api)
- [Подключение Perplexica к сети](#expose-perplexica-to-network)
- [Деплой в один клик](#one-click-deployment)
- [Предстоящие функции](#upcoming-features)
